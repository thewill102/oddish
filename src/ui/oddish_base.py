...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.getSteam.setText(_translate("MainWindow", "Get Steam Cookies"))
        self.getBuff.setText(_translate("MainWindow", "Get Buff Cookies"))
        self.label_3.setText(_translate("MainWindow", "Price limit："))
        self.priceMin.setSuffix(_translate("MainWindow", "¥"))
        self.label_4.setText(_translate("MainWindow", "-"))
        self.priceMax.setSuffix(_translate("MainWindow", "¥"))
        self.typeRestrict.setText(_translate("MainWindow", "Type limitation"))
        self.label_7.setText(_translate("MainWindow", "Proxy:"))
        self.proxyVaild.setText(_translate("MainWindow", "..."))
        self.crawlStart.setText(_translate("MainWindow", "Start"))
